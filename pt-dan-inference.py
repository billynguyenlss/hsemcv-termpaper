...
PTH = os.path.join(PRETRAINED_MODEL_DIR, 'DAN_epoch_5_acc0.7263_f1-0.6438.pth')

# load model
model = DAN2(num_head=4, num_class=6, pretrained=False)
...
print('dan: avg time: {:.3f} sec, fps: {:.2f}\n'.format(et/100, 100/et))
