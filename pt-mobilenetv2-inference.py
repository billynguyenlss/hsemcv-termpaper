...
PTH = os.path.join(PRETRAINED_MODEL_DIR, 'mobilenetv2_epoch_4_acc0.914610331972306_f1-0.9101.pth')

# load model
model = create_mobilenetv2_model(True)
...
print('MobileNetV2: avg time: {:.3f} sec, fps: {:.2f}\n'.format(et/100, 100/et))
