...
PTH = os.path.join(PRETRAINED_MODEL_DIR, 'hsemotion-dan_enet_b0_8_va_mtl.pt_epoch_5_acc0.7107_f1-0.6197.pth')
...
# load model
model = HSEmotionEffNetDAN(num_head=4, num_class=6, pretrained=True, pretrained_ckp=PRETRAINED_PT)
...
print('hsemotion-dan: avg time: {:.3f} sec, fps: {:.2f}\n'.format(et/100, 100/et))

# from to_pytorch import quantized_model_for_mobile, quantize_model_int8
# quantized_model_for_mobile(model, 'hsemotion-dan', 'pretrained/pt-quantized-for-mobile')
# quantize_model_int8(model, 'hsemotion-dan', 'pretrained/pt-quantized')